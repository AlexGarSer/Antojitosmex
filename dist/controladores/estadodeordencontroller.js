      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            pool = _context.sent;
            _context.next = 6;
            return pool.query(_database.queries.getEstadoDeOrden);
          case 6:
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            pool = _context2.sent;
            _context2.next = 9;
            return pool.query(_database.queries.postEstadoDeOrden, Descripcion);
          case 9:
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            pool = _context3.sent;
            _context3.next = 7;
            return pool.query(_database.queries.getEstadoDeOrdenById, Id);
          case 7:
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            pool = _context4.sent;
            _context4.next = 7;
            return pool.query(_database.queries.deleteEstadoDeOrdenById, Id);
          case 7:
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            pool = _context5.sent;
            _context5.next = 10;
            return pool.query(_database.queries.updateEstadoDeOrdenById, [Descripcion, Id]);
          case 10:

      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            pool = _context.sent;
            _context.next = 6;
            return pool.request().query(_database.queries.getCarrito);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            .input("Fecha", _database.sql.VarChar, Fecha).input("IdUsuario", _database.sql.VarChar, IdUsuario).input("IdOrden", _database.sql.Int, IdOrden).input("Total", _database.sql.Float, Total) // este es el query real
            .query(_database.queries.postCarrito);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            pool = _context3.sent;
            _context3.next = 6;
            return pool.request().input('Id', Id).query(_database.queries.getCarritoById);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            pool = _context4.sent;
            _context4.next = 6;
            return pool.request().input('Id', Id).query(_database.queries.deleteCarritoById);
...
var updateCarritoById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var _req$body2, Fecha, IdUsuario, Id, pool;

    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _req$body2 = req.body, Fecha = _req$body2.Fecha, IdUsuario = _req$body2.IdUsuario;
            Id = req.params.Id;
          ...
          case 6:
            pool = _context5.sent;
            _context5.next = 9;
            return pool.request().input("Id", Id).input("Fecha", _database.sql.VarChar, Fecha).input("IdUsuario", _database.sql.VarChar, IdUsuario).input("IdOrden", _database.sql.Int, IdOrden).input("Total", _database.sql.Float, Total).query(_database.queries.updateCarritoById);
